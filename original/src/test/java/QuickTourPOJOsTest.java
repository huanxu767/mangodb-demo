...
public class QuickTourPOJOsTest {
    ...
    public void before() {
        ...
        database = mongoClient.getDatabase("test-xh").withCodecRegistry(pojoCodecRegistry);
...
//        database = mongoClient.getDatabase("test-xh");
    ...
    public void insertAPerson() {
        ...
        Person ada = new Person("虚幻", 20, new Address("St James Square", "London", "W1"));
    ...
    public void replaceAsinglePerson(){
        ...
        collection.replaceOne(eq("name", "虚幻改"), ada);
